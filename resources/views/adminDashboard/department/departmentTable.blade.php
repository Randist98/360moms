                        ...
                        <div class="header-left">
                            <div class="search_bar dropdown">
                                ...
                                <div class="dropdown-menu p-0 m-0" style="display: flex; align-items: center; justify-content: center; padding: 10px;">
                                    <form action="{{ route('adminDashboard.department.index') }}" method="GET">
                                        @csrf
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" style="font-size: 20px"> department Table</h4>
                               <a href="{{route('departmentTable.create')}}"> <button class="my-button" >Add</button></a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 50px">
                                                    ...
                                                    <form method="POST" action="{{ route('departmentTable.destroy', $department->id) }}" accept-charset="UTF-8" style="display:inline">
                                                        @method('DELETE')
                                                        @csrf
                                                    ...
                                                    <a href="{{ route('departmentTable.edit', $department->id) }}" title="Edit Office">
